...
<body>
    <main>
        ...
        <h1>Products (Resource Controller)</h1>
        <p class="subtitle">Data from: ProductController@index</p>

        <!-- Shared Variables Section -->
        <div class="section">
            <div class="section-title">Shared Variables from Service Providers</div>
            <div class="variable-box">
                <span class="variable-label">Product Key:</span>
                <span class="variable-value">{{ $productKey ?? 'Not set' }}</span>
            </div>
            <div class="variable-box">
                <span class="variable-label">Shared Variable:</span>
        ...
        <div class="section">
            ...
            @forelse($products as $product)
                <div class="product-card">
                    ...
                    <div class="product-category">Category: {{ $product['category'] ?? 'N/A' }}</div>
        ...
        <div class="section">
            ...
            <div class="summary-grid">
                ...
                <div class="summary-item">
                    ...
                    <span class="summary-value">ProductController@index</span>
                </div>
                <div class="summary-item">
                    <span class="summary-label">Services Used:</span>
                    <span class="summary-value">ProductService, TaskService</span>
                </div>
            </div>
        </div>
    </main>
